...
Components do not have access to the state of the parent template. However, they can access templates [globals](../guide/data-flow.md#globals) and [locals](../guide//data-flow.md#locals).
